...
Cette année, avec l'équipe, on a passé une bonne journée durant la WWDC pour se faire des ateliers et aussi participer à la Swift Connection.

C'était quand même une année éprouvante, beaucoup de challenges, de deadlines claquées. Mais heureusement il y a eu aussi de belles rencontres qui valent la peine de se lever le matin.
...
Le but est d'avoir une fiscalité plus avantageuse que l'auto-entreprise et surtout d'avoir une image plus sérieuse pour faire avancer mes projets.


## Retour sur les objectifs de 2024

La rentabilité de mes apps était un objectif et elle est réussie !

![MRR](../../assets/images/arr2025.png)

Réduction du coût de mes serveurs, augmentation du nombre d'abonnements dans mes apps.

Bref, pas de l'argent pour de l'argent, mais bien pour produire un service avec un retour sur investissement.
...
Encore une fois, Baby-link est là. Mais elle ne prend pas : j'ai eu quelques utilisateurs mais ils ne restent pas... 

J'avais eu une piste de partenariat avec une crèche mais j'ai loupé le coche.

À chaque fois que j'en parle autour de moi, les mêmes réactions : Trop bien !

Voilà trop d'années maintenant que je vous parle du projet Baby-link. C'est un projet de cœur et ce sont peut-être finalement les pires à gérer ?

Initialement bloquée au marché français, l'application est en cours d'ouverture au global.

### Reef Buddy

Mon application pour suivre l’aquarium marin : j'ai beaucoup travaillé dessus cette année.
Travaux sur l'ASO, migration du backend, intégration d'abonnements pour aider les utilisateurs à comprendre leurs mesures.
...
Mazout est une application pour trouver et acheter son carburant moins cher. J'ai enfin obtenu l'agrément CarPlay, mais je n'ai pas encore passé de temps dessus. Je l'ai donc laissée en attente pour le moment.
...
J'ai hâte de voir Noël et la fin d'année s'il y a toujours le même pic d'achat.

### Stop SMS

Elle permet de détecter les spams SMS. 
...
Lancée en 2023, cette application permet de saisir et de suivre le kilométrage d’une location LOA.
Je suis toujours content de l'avoir et la trouve toujours aussi utile ; je dois trouver un moyen de la promouvoir et d'augmenter le taux de conversion.
...
Lancée l'année dernière, cette application a un but simple : suivre les notes et reviews de l’App Store et assister l’utilisateur grâce à l'IA dans l’écriture des réponses.
Elle ne prend pas du tout. Elle m'est vraiment utile, mais elle sera sûrement supprimée des stores.
...
Inspiré par plein d'indie devs, je rêve de leur place et j'ai pour objectif clair d'augmenter mon ARR.
