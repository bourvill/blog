---
title: Wallabag release 6.0.0
pubDate: 2021-01-27 21:00
...
After several months on other personal projects, it was time for me to work again on the iOS version of wallabag.
This version with a major tag includes only a few new visible functionalities.

[https://github.com/wallabag/ios-app/compare/5.2.4...6.0.0](https://github.com/wallabag/ios-app/compare/5.2.4...6.0.0)

Many commits by weblate and "build", I think I could do better on this side to make the git more readable.

## Feature

It incorporates new translations based on the work of the community. You can participate [here](https://hosted.weblate.org/engage/wallabag/en/)!

Text-to-speech is back with a new small player.

Entry menu is reworked and better integrated for the light/dark UI.

Added confirmation on delete entry (requested by jrabensc)

Fixed some alignment in main menu using the new label system (spotted by jrabensc)
...
There are a lot of changes in the code. Code migrated to SwiftUI 2.
